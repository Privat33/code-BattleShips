// create a function that will be made of all the name of the cell of our table
...
// create an object Board that contain the final value of the function CreateTable
...
// execute the function changeId()
changeId();
// create that a function that will make a random selection in our Board
...
function verifyUserFindAllShips(){
    ...
    if(shipFind.length==6){
        ...
        msg.innerHTML='Congratulation you got all the ship! You win!!';
    }
    // return the message
    return msg;
}
// create a function that will verify if the user miss or hit a ship
function verifyIfMissOrHit(validBoardShipPosition){
    ...
    if(listId.includes(guess)){
        ...
        // else
            ...
            message.innerHTML='You miss it try again!';
        }
        //else 
    }else{
